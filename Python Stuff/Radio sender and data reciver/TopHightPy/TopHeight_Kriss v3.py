...
fire_img2 = pygame.image.load('fire2.png')
fire_img3 = pygame.image.load('fire3.png')
fire_img4 = pygame.image.load('fire4.png')

#Animation
fire_animation = [fire_img4, fire_img3, fire_img2, fire_img]
    ...
    def Draw(self):
        ...
        if self.move == True:
            ...
            if self.fire_counter == 0:
                self.fire_counter = self.fire_counter_MAX
                self.fire_anime_count += 1
                if self.fire_anime_count == len(fire_animation):
                    self.fire_anime_count = 0
            SCREEN.blit(fire_animation[self.fire_anime_count], ((self.X), (self.Y+26)))#ILD
